...
state.layers.forEach(l => {
  console.log(`Layer: "${l.name}" | Type: ${l.type} | Bounds: x=${l.bounds.x}, y=${l.bounds.y}, w=${l.bounds.width}, h=${l.bounds.height} | stableId: ${l.stableNodeId}`);
});
