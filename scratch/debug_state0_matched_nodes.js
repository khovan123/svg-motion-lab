...
console.log("State 0 matched layers and elements:");
matchedNodes.forEach((node, stableNodeId) => {
  const b = getAbsoluteBounds(node);
  console.log(`- ${stableNodeId}: <${node.tagName}> bounds=${b ? JSON.stringify(b) : 'null'}`);
});
