...
const vt = verifyTracks.find(t => t.id === containerId);
const dt = parsedDistTracks.find(t => t.id === containerId);
console.log('Verify Container Track:', JSON.stringify(vt, null, 2));
console.log('Dist Container Track:', JSON.stringify(dt, null, 2));
