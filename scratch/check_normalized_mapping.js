...
console.log('Layers in normalized state 0 containing mask-group:');
state0.layers.forEach(l => {
  if (l.stableNodeId.includes('mask-group')) {
    console.log(`  stableNodeId = ${l.stableNodeId}, visible = ${l.visible}`);
  }
});
