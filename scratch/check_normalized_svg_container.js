...
console.log('Is container[0] in state 0 SVG string of normalized manifest?');
const hasIt = state0.svg.includes('container[0]');
...
if (hasIt) {
  ...
  console.log('  element tag =', el ? el.tagName : 'null');
}
