...
console.log('Elements with data-motion-id under defs in Dist:');
if (defs) {
  defs.querySelectorAll('[data-motion-id]').forEach(el => {
    console.log('  ', el.tagName, el.getAttribute('data-motion-id'), 'parent:', el.parentNode ? el.parentNode.getAttribute('id') : 'null');
  });
}
