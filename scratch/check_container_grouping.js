...
const el = rootSvg.querySelector('[data-motion-id="1:4181:@root/container[0]"]');
if (el) {
  const b = compiler.getAbsoluteBounds(el);
  console.log('Bounds of container element in state 0:', b);
} else {
  console.log('Container element NOT FOUND in state 0 raw SVG!');
}
