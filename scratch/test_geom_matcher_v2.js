...
function matchGeometryGloballyV2(state) {
  ...
  // 1. Match leaf shape layers first
  ...
  // 2. Match container/group layers by using the matches of their children (bottom-up) or falling back to bounds
  // Sort container layers so deeper containers are matched first
...
console.log("Running Two-Phase Matcher on State 2...");
matchGeometryGloballyV2(manifest.states[2]);
