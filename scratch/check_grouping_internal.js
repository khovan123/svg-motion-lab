...
fs.writeFileSync(path.join(scratchDir, 'semantic-15-debug-grouping.js'), code, 'utf8');
...
const scripts = [
  ...
  'semantic-11.js', 'semantic-12.js', 'semantic-15-debug-grouping.js', 'semantic-13.js', 'semantic-14.js',
  'semantic-16.js', 'semantic-runtime-fix.js'
];

for (const scriptName of scripts) {
  let fileCode;
  if (scriptName === 'semantic-15-debug-grouping.js') {
    fileCode = fs.readFileSync(path.join(scratchDir, 'semantic-15-debug-grouping.js'), 'utf8');
  } else {
